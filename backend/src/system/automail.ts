...
const activateAutoMailing = async (data: any) => {
    ...
    await sendMail({
        ...
        htmlMessage: `Note: This is an automated report generated by the Stockpilot: Full Scale Inventory. Please do not reply to this email. For any queries, contact [Support Email/Phone Number].`, 
