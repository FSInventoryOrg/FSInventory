...
const AddEmployee = () => {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent
        tabIndex={-1}
        className="min-w-full overflow-y-auto h-full bg-transparent items-center justify-center flex border-none px-0 py-0 sm:py-16"
      >
        <div className="sm:max-w-[800px] w-full bg-card h-fit p-0 rounded-lg border">
              ...
              >
                ...
                >
                  ...
                  <div className="self-end flex flex-row justify-center items-center gap-2">
                    ...
                    <Button
                      type="submit"
                      disabled={isAddEmployeePending || isAssetEditPending}
                      className="gap-2"
                    >
                      {isAddEmployeePending || isAssetEditPending ? (
                        <Spinner size={18} />
                      ) : null}
                      Add Employee
                      <ArrowRightIcon />
