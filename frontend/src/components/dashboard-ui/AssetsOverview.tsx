  ...
  return (
    <div className='grid grid-cols-2 gap-7'>
      ...
      <div className='flex gap-2 items-center justify-start'>
        <div 
          className='min-h-12 min-w-12 sm:min-h-16 sm:min-w-16 flex justify-center items-center rounded-xl'
          style={{ backgroundColor: deployed ? `${deployed.color}30` : hexToRgbA('#8d8d8d', 0.3) }}
        >
          <RocketLaunch weight='duotone' size={32} style={{ color: deployed ? deployed.color : '#8d8d8d' }} />
        </div>
        <div className='flex flex-col'>
      ...
      <div className='flex gap-2 items-center justify-start'>
        <div 
          ...
          style={{ backgroundColor: storage ? `${storage.color}30` : hexToRgbA('#8d8d8d', 0.3) }}
        >
          <Dresser weight='duotone' size={32} style={{ color: storage ? storage.color : '#8d8d8d' }} />
        </div>
        <div className='flex flex-col'>
      ...
      <div className='flex gap-2 items-center justify-start'>
        <div 
          className='min-h-12 min-w-12 sm:min-h-16 sm:min-w-16 flex justify-center items-center rounded-xl'
          style={{ backgroundColor: damaged ? `${damaged?.color}30` : hexToRgbA('#8d8d8d', 0.3) }}
        >
          <EggCrack weight='duotone' size={32} style={{ color: damaged ? damaged.color : '#8d8d8d' }} />
        </div>
        <div className='flex flex-col'>
