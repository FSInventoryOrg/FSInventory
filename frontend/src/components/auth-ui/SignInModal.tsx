...
const SignInModal = () => {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent
        tabIndex={-1}
        className="min-w-full overflow-y-auto h-fit bg-transparent items-center justify-center flex border-none px-0 py-0 sm:py-16"
      >
        <div className="sm:max-w-[500px] w-full bg-card h-fit flex justify-between flex-col gap-6 p-6 rounded-lg">
          <DialogHeader className="relative">
            ...
            <DialogDescription className="flex flex-col gap-4">
              <span className="w-full flex justify-center text-xl text-primary font-semibold">
                Enter your account
              </span>
            </DialogDescription>
          </DialogHeader>
          <div className="flex flex-col w-full justify-center px-0 md:px-16 md:pb-12 gap-4">
            ...
            <SignInForm onError={handleErrorAlert} onSubmit={() => {}} />
          </div>
        </div>
      </DialogContent>
    </Dialog>
