...
export const FullScaleIcon = ({className, size = 24, width, height, ...props}: IconSvgProps) => (
  <svg
    aria-hidden="true"
    height={size || height} 
    width={size || width}
  ...
  >
    <g transform="translate(0.000000,500.000000) scale(0.100000,-0.100000)" className={className} stroke="none">
