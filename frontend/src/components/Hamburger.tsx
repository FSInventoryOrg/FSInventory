      ...
      <SheetContent closeIcon={false} side="left" className='px-2 py-4 w-64 border-none flex flex-col justify-start' >
        <div className='flex gap-3 mb-4 px-2 items-center'>
          ...
          <SheetPrimitive.Close className="w-full">
            <Link to="/home" className="flex items-center justify-start gap-3 text-primary" reloadDocument>
        ...
        <div className="w-full flex flex-col gap-2 items-center">
          ...
          <SheetPrimitive.Close className="w-full">
            <Link to="/report" className="w-full flex gap-4 text-xl justify-start px-3 py-3 items-center hover:bg-accent hover:text-accent-foreground rounded-md font-medium" reloadDocument>
              <BarChartIcon size={24} className={location.pathname === '/report' ? "text-primary" : ""} />
              <span>Report</span>            
            </Link>
          </SheetPrimitive.Close>
          <SheetPrimitive.Close className="w-full">
