...
export const RequestFormSchema = z
  ...
  .and(
    z.union([ReportIssueSchema, RequestNewAssetSchema])
    // z.union([
    //   z
    //     .object({ requestType: z.literal("Report an Issue") })
    //     .and(ReportIssueSchema),
    //   z
    //     .object({ requestType: z.literal("Request a New Asset") })
    //     .and(RequestNewAssetSchema),
    // ])
  );
